        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Servelink simplifies your fullstack project deployment
            </h2>
          </div>
          {/* Planet */}
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-linear-to-b before:from-purple-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-purple-500),transparent)]">
                <Image
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Laravel Deployment</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Deploy your Laravel applications in just a few clicks with full
                support for migrations, queues, and automatic production
                optimizations.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Deploy your Django, Flask, FastAPI and other Python frameworks
                with automatic dependency management and virtual environments.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Deploy your Node.js, React, Next.js and other JavaScript
                frameworks with automatic builds and integrated performance
                optimizations.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Automatic management of MySQL, PostgreSQL, MongoDB databases
                with automatic backups and real-time monitoring.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Integrated CI/CD</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Continuous deployment pipeline with automatic testing,
                staging and production deployment, and instant rollback.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Real-time application monitoring with centralized logs,
                custom alerts and performance metrics.
              </p>
            </article>
          </div>
        </div>
