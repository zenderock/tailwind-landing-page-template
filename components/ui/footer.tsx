  ...
  return (
    <footer>
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; Servelink - All rights reserved.
            </div>
          </div>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="flex gap-1">
              <li>
                <Link
                  className="flex items-center justify-center text-purple-500 transition hover:text-purple-600"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
      ...
      <div className="relative -mt-16 h-60 w-full" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[348px] font-bold leading-none before:bg-linear-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-['Servelink'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['Servelink'] after:[text-shadow:0_1px_0_white]"></div>
        {/* Glow */}
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-2/3"
          aria-hidden="true"
        >
          <div className="h-56 w-56 rounded-full border-[20px] border-purple-700 blur-[80px]"></div>
        </div>
      </div>
    </footer>
  );
